	...
	public class SetorTela extends JDialog implements ActionListener {
	    ...
	    public SetorTela(Frame owner, String title, boolean modal, SNEO sneo, SetorTabela sTabela) {
		...
		public void confirmar(){
			...
			if(operacao == '1'){
				...
				if(sTabela.add(Integer.parseInt(tfCodigo.getText()), tfNome.getText())=='1')
	  	...
	  	public void visualizar(){
	  		if(sTabela.getNumero()==0)
		    	...
		    	JOptionPane.showMessageDialog(null, ""+sTabela.getSetor(i)+"\n","Aviso", JOptionPane.INFORMATION_MESSAGE);	      
	  		}
	  	}
